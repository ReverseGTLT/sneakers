...
export default function Card(props) {
    ...
    return (
        <div className="card">
            <div className="card__like cursor" onClick={props.onClickFavorite}>
            ...
            <div className="card__info">
                <div className="cars__coast">
                    ...
                    <p className="card__sum">{props.price} руб.</p>
                </div>
                <div className="card__plus cursor" onClick={addToCart}>
                    <img src={added ? '/image/plus-done.svg' : '/image/plus.svg'} alt=""/>
                </div>
            </div>
        </div>
    )
