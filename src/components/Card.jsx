...
export default function Card({ onPlus, image, price, title, isItemAdded, isItemFavorite, onFavorite, favorited = false, addedToCartItem = false, id }) {
        ...
        <div className="card">
            ...
            <div className="card__info">
                ...
                <div className="card__plus cursor" onClick={addToCart}>
                    <img src={isItemAdded() ? '/image/plus-done.svg' : '/image/plus.svg'} alt="plus"/>
                </div>
            </div>
        </div>
    )
