...
export default function FavoriteItem({ addToCart, removeFromFavorite, image, price, title, onFavorite, favorited = false, addedToCartItem = false }) {
    ...
    return (
        <div className="card">
            <div className="card__like cursor" onClick={removeFromFavorite}>
